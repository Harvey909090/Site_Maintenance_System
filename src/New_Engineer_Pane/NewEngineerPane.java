...
public class NewEngineerPane extends javax.swing.JPanel {
    ...
    public NewEngineerPane() {
        EngineerHandling.Load();
        initComponents();
        idTextField.setText(EngineerHandling.EngineerID()+"");
    ...
    public EngineerInfo getData()
    {
        ...
        return new EngineerInfo(id, name, phone, cnic, Ename, ephone,addrss, dob, email, img.toByteArray(),pst, sal, time);
