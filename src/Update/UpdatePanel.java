...
import Update_Engineer_Panel.UpdateEngineer;
import Update_Password.ChangePassword;
import Update_Salary.UpdateSalarySlips;

public class UpdatePanel extends javax.swing.JPanel {

    TitlePane titlePane = null;
    UpdateEngineer updateEngineer = null;
    UpdateSalarySlips updateSalary = null;
    ...
    private void updateEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateEmployeeButtonActionPerformed
        hidePanels();
        updateEngineer.setVisible(true);
    ...
    private void loadPanels()
    {
        ...
        //update_employee
        updateEngineer = new UpdateEngineer();
        backbonePanel.add(updateEngineer);
        updateEngineer.setSize(1330, 520);
        
        //update_Salaryslips
        updateSalary = new UpdateSalarySlips();
        backbonePanel.add(updateSalary);
        updateSalary.setSize(1330, 520);
    ...
    private void hidePanels()
    {
        ...
        updateEngineer.setVisible(false);
