...
public class UpdateEngineerDialog extends javax.swing.JDialog {

    /**
     * Creates new form UpdateEngineerDialog
     */
    ...
    byte[] pic;
    EngineerInfo personalInfo = null;
    
    public UpdateEngineerDialog(java.awt.Frame parent, boolean modal, EngineerInfo personalInfo) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Site Maintenance System");
        ...
        jLabel3.setText("Engineer - Details");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        EngineerHandling.DeleteRecord(personalInfo);
        this.dispose();
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try{
            ...
            EngineerHandling.UpdateRecord(new EngineerInfo(Integer.parseInt(idTextField.getText()), fullnameTextField.getText(), phoneTextField.getText(),
