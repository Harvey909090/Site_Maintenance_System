...
import Update_Salary.Salary_Class;
...
public class SalarySlipDetail extends javax.swing.JDialog {
     ...
     * @param salary
     */
    public SalarySlipDetail(java.awt.Frame parent, boolean modal, Salary_Class salary) {
        super(parent, modal);
        initComponents();
        
        idLabel.setText(salary.getId()+"");
        nameLabel.setText(salary.getName());
        positionLabel.setText(salary.getPost());
        salaryMonthLabel.setText(salary.getMonthName());
        workingDaysLabel.setText(salary.getTotalWorkingDays()+"");
        advanceLabel.setText(salary.getAdvance()+"");
        deductionLabel.setText(salary.getDeduction()+"");
        netSalaryLabel.setText(salary.getNetSalary()+"");
        issueDateLabel.setText(salary.getDate());
        totalAmountLabel.setText(salary.getGross()+"");
    }
    /**
